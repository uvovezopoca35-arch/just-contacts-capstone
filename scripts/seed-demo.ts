...
const CONTACTS: DemoContact[] = [
  {
    name: 'Alex Rivera', firstName: 'Alex', role: 'Backend Developer at Stripe',
    tags: ['WORK', 'TECH'], phone: '+1 415 555 0142', email: 'alex.rivera@example.com',
    birthday: '1994-03-12',
    recentSummary: 'Backend developer at Stripe, met at the AI conference. Into snowboarding; works mostly with Go and distributed systems.',
    facts: [{ label: 'Company', value: 'Stripe' }, { label: 'Role', value: 'Backend Developer' }],
    history: [
      { type: 'meeting', date: '2026-05-18', summary: 'Met at the AI conference, talked about vector databases. Promised to send a paper on HNSW indexes.' },
      { type: 'call', date: '2026-06-02', summary: 'Quick call — hiring a junior backend dev on the team.' },
    ],
  },
  {
    name: 'Maya Chen', firstName: 'Maya', role: 'Product Designer',
    tags: ['DESIGN', 'WORK'], email: 'maya.chen@example.com', birthday: '1996-07-21',
    ...
    history: [
      { type: 'meeting', date: '2026-04-30', summary: 'Lunch after the design meetup. Showed her Figma portfolio; interested in design-systems work.' },
    ],
  },
  {
    name: 'Tom Becker', firstName: 'Tom', role: 'Car Mechanic',
    tags: ['SERVICES', 'FRIEND'], phone: '+1 312 555 0188',
    recentSummary: 'Friend who fixes cars — has his own garage. Owns a cabin outside the city and grills well.',
    facts: [{ label: 'Role', value: 'Car Mechanic' }],
  },
  {
    name: 'Sofia Romano', firstName: 'Sofia', role: 'Marketing Lead at a fintech startup',
    tags: ['WORK', 'MARKETING'], email: 'sofia.romano@example.com',
  ...
  {
    name: 'Lucas Müller', firstName: 'Lucas', role: 'Freelance Photographer',
    tags: ['CREATIVE', 'FREELANCE'], phone: '+49 30 555 0173', birthday: '1990-11-05',
    recentSummary: 'Freelance photographer, travels a lot. Shoots events and portraits; based in Berlin.',
    facts: [{ label: 'Role', value: 'Photographer' }],
  },
  {
    name: 'Priya Nair', firstName: 'Priya', role: 'Data Scientist',
    tags: ['TECH', 'WORK'], email: 'priya.nair@example.com',
  ...
  {
    name: 'Daniel Foster', firstName: 'Daniel', role: 'Angel Investor',
    tags: ['FINANCE', 'NETWORK'], email: 'daniel.foster@example.com', isFavorite: true,
  ...
  {
    name: 'Hannah Kim', firstName: 'Hannah', role: 'UX Researcher',
    tags: ['DESIGN', 'RESEARCH'], email: 'hannah.kim@example.com',
  ...
  {
    name: 'Marco Rossi', firstName: 'Marco', role: 'DevOps Engineer',
    tags: ['TECH'], phone: '+1 206 555 0119',
  ...
  {
    name: 'Aisha Khan', firstName: 'Aisha', role: 'Cardiologist',
